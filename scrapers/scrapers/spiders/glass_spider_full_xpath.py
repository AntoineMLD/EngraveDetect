...
class GlassSpiderFullXPath(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        supplier_name = response.xpath('/html/body/div[2]/div/div[3]/div/div/div/text()').get()
        ...
        for line in lines:
            ...
            material = line.xpath('/html/body/div[2]/div/div[4]/div/div/div[1]/div[4]/div[6]/p').get()
