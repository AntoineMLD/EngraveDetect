...
class GlassSpiderParticular(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        supplier_name = response.xpath('/html/body/div[2]/div/div[3]/div[2]/h2/text()').get() or \
                response.xpath('/html/body/div[2]/div/div[3]/div/div/div/text()').get()

            
        
        lines_container = response.xpath('//div[contains(@class, "tableau_gravures") and contains(@class, "show-on-large") and contains(@class, "hide-on-med-and-down")]')
