...
class PairDataset(Dataset):
    ...
    def __init__(self, csv_file, dataset_dir, transform=None):
        ...
        self.dataset_dir = Path(dataset_dir).parent  # On remonte d'un niveau car les chemins dans le CSV incluent train/test
...
class SiameseTrainer:
    ...
    def __init__(self, model: nn.Module, criterion: nn.Module, optimizer: optim.Optimizer,
                 device: torch.device, model_dir: Path):
        """
    ...
    def validate(self, val_loader: DataLoader, threshold: float = 1.0) -> Tuple[float, float]:
        """
    ...
    def train(self, train_loader: DataLoader, val_loader: DataLoader, 
              num_epochs: int, save_frequency: int = 5):
        """
