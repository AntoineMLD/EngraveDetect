...
def create_verre_index(client):
    ...
    fields = [
        ...
        SearchableField(name="variante", type=SearchFieldDataType.String,
                       searchable=True, filterable=True),
        SimpleField(name="hauteur_min", type=SearchFieldDataType.Int32,
                   filterable=True, sortable=True),
        SimpleField(name="hauteur_max", type=SearchFieldDataType.Int32,
                   filterable=True, sortable=True),
        SimpleField(name="indice", type=SearchFieldDataType.Double,
                   filterable=True, sortable=True),
        ...
        # Relations
        ComplexField(name="fournisseur", fields=[
            SimpleField(name="id", type=SearchFieldDataType.Int64),
            SearchableField(name="nom", type=SearchFieldDataType.String,
                          searchable=True, filterable=True, facetable=True)
        ]),
        
        ComplexField(name="materiau", fields=[
            SimpleField(name="id", type=SearchFieldDataType.Int64),
            SearchableField(name="nom", type=SearchFieldDataType.String,
                          searchable=True, filterable=True, facetable=True)
        ]),
        
        ComplexField(name="gamme", fields=[
            SimpleField(name="id", type=SearchFieldDataType.Int64),
            SearchableField(name="nom", type=SearchFieldDataType.String,
                          searchable=True, filterable=True, facetable=True)
        ]),
        
        ComplexField(name="serie", fields=[
            SimpleField(name="id", type=SearchFieldDataType.Int64),
            SearchableField(name="nom", type=SearchFieldDataType.String,
                          searchable=True, filterable=True, facetable=True)
        ]),
        ...
        ComplexField(name="symboles", collection=True, fields=[
            SimpleField(name="id", type=SearchFieldDataType.Int64),
            SearchableField(name="nom", type=SearchFieldDataType.String,
                          searchable=True, filterable=True),
            SearchableField(name="description", type=SearchFieldDataType.String,
                          searchable=True),
            SimpleField(name="score_confiance", type=SearchFieldDataType.Double,
                       filterable=True)
        ]),
        
        ComplexField(name="traitements", collection=True, fields=[
            SimpleField(name="id", type=SearchFieldDataType.Int64),
            SearchableField(name="nom", type=SearchFieldDataType.String,
                          searchable=True, filterable=True),
